  ...
  var y = /:[0-9]+$/,
    A = function(a, b) {
      ...
      'port' === b
        ...
        : 'host' === b &&
          (a.hostname = (a.hostname || r.location.hostname).replace(y, '').toLowerCase());
      var c = z(a.protocol);
      b && (b = String(b).toLowerCase());
      switch (b) {
            ...
            try {
              ...
              if (1 > ca.length) ge('xhr', 'ver', '0'), c();
                ...
                if ('d' == l) pe('https://stats.g.doubleclick.net/j/collect', d.U, d, c);
                  ...
                  k &&
                    (/^[a-z.]{1,6}$/.test(k)
                      ? wc('https://www.google.%/ads/ga-audiences'.replace('%', k), d.google, ua)
                      : ge('tld', 'bcc', k));
                } else ge('xhr', 'brc', l), c();
              }
            } catch (w) {
        ...
        if (a.get(je)) {
          ...
          if (c) {
            ...
            g && 'aw.ds' != g
              ? b && (b.ua = !0)
              : ((c = ['1', e, Cc(c)].join('.')),
                0 < d && (b && (b.ta = !0), zc('_gac_' + Cc(a), c, ca, l, a, d)));
            le(b);
          }
        } else J(75);
      }
      ...
      if (!ea(Yd.get(b)) && !$d.get(b)) {
        ...
        if (c) {
          ...
          if (('https:' == a || a == d || ('http:' != a ? 0 : 'http:' == d)) && B(ca)) {
            if ((ca = ca.url))
              (a = (a = (M.querySelector && M.querySelector('script[nonce]')) || null)
                ? a.nonce || (a.getAttribute && a.getAttribute('nonce')) || ''
                : ''),
                e
                  ? ((e = ''),
                    a && Nd.test(a) && (e = ' nonce="' + a + '"'),
                    f.test(ca) && M.write('<script' + e + ' src="' + ca + '">\x3c/script>'))
