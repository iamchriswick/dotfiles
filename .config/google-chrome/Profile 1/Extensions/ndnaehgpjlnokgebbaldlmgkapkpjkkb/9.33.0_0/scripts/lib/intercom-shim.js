!(function(e) {
    ...
    18: function(e, t, n) {
        ...
        function p(e) {
            return (
                void 0 === e && (e = m().userAgent), /iPad|iPhone|iPod/.test(e) && !window.MSStream
            );
        }
        function f() {
    ...
    283: function(e, t, n) {
        ...
        var r = n(18),
            o = function(e, t, n) {
                void 0 === n && (n = 'en'),
                    r.a.isFirefox() && (e.contentDocument.open(), e.contentDocument.close()),
                    (function(e, t, n) {
                        void 0 === n && (n = 'en'),
    ...
    945: function(e, t, n) {
        ...
        var u = n(283),
            c = n(289).public_path;
        var a = c + 'intercom-frame.js',
            d = c + 'intercom-vendor.js',
            s = c + 'intercom-frame-modern.js',
            m = c + 'intercom-vendor-modern.js',
            p = /bot|googlebot|crawler|spider|robot|crawling|facebookexternalhit/i,
            f = function() {
            ...
            h = function() {
                ...
                (n.id = 'intercom-frame'),
                    ...
                    Object(u.b)(
                        ...
                        '<!doctype html>\n    <html lang="en">\n      <head>\n       ' +
                            t +
                            '\n      </head>\n      <body data-intercom-path="' +
                            window.MT_INTERCOM_PATH +
                            '">\n</body>\n    </html>'
                    );
                var r,
                    o = !!(r = l()) && r[0] >= 81,
                    ...
                    c = Object(u.a)(o ? m : d);
                return (
                    n.contentDocument.head.appendChild(i), n.contentDocument.head.appendChild(c), n
                );
            },
            w = function() {
            ...
            g = function() {
                f() || (v(), h(), (window.Intercom.booted = !0));
            };
        ('attachEvent' in window && !window.addEventListener) ||
            ...
            (function(e, t, n) {
                ...
                window.Intercom('shutdown', !1), delete window.Intercom, w(), v();
            }));
    },
});
